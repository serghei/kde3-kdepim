    ...
    : QWidget(parent, name), m_viewMode(NormalView), m_actionManager(actionManager)
{
    ...
    connect(m_feedListView, SIGNAL(signalContextMenu(KListView *, TreeNode *, const QPoint &)), this, SLOT(slotFeedTreeContextMenu(KListView *,
            TreeNode *, const QPoint &)));
    ...
    connect(m_tagNodeListView, SIGNAL(signalContextMenu(KListView *, TreeNode *, const QPoint &)), this, SLOT(slotFeedTreeContextMenu(KListView *,
            TreeNode *, const QPoint &)));
    ...
    connect(m_articleList, SIGNAL(signalMouseButtonPressed(int, const Article &, const QPoint &, int)), this, SLOT(slotMouseButtonPressed(int,
            const Article &, const QPoint &, int)));
    ...
    connect(m_searchBar, SIGNAL(signalSearch(const Akregator::Filters::ArticleMatcher &, const Akregator::Filters::ArticleMatcher &)), m_articleList,
            SLOT(slotSetFilter(const Akregator::Filters::ArticleMatcher &, const Akregator::Filters::ArticleMatcher &)));

    connect(m_searchBar, SIGNAL(signalSearch(const Akregator::Filters::ArticleMatcher &, const Akregator::Filters::ArticleMatcher &)), m_articleViewer,
            SLOT(slotSetFilter(const Akregator::Filters::ArticleMatcher &, const Akregator::Filters::ArticleMatcher &)));
