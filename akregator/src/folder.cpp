...
{
    Folder *fg = new Folder(e.hasAttribute(QString::fromLatin1("text")) ? e.attribute(QString::fromLatin1("text")) : e.attribute(
...
void Folder::connectToNode(TreeNode *child)
{
    ...
    connect(child, SIGNAL(signalArticlesAdded(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesAdded(TreeNode *,
            const QValueList<Article> &)));
    connect(child, SIGNAL(signalArticlesRemoved(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesRemoved(TreeNode *,
            const QValueList<Article> &)));
    connect(child, SIGNAL(signalArticlesUpdated(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesUpdated(TreeNode *,
            const QValueList<Article> &)));
}
...
void Folder::disconnectFromNode(TreeNode *child)
{
    ...
    disconnect(child, SIGNAL(signalArticlesAdded(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesAdded(TreeNode *,
               const QValueList<Article> &)));
    disconnect(child, SIGNAL(signalArticlesRemoved(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesRemoved(TreeNode *,
               const QValueList<Article> &)));
    disconnect(child, SIGNAL(signalArticlesUpdated(TreeNode *, const QValueList<Article> &)), this, SIGNAL(signalArticlesUpdated(TreeNode *,
               const QValueList<Article> &)));
}
