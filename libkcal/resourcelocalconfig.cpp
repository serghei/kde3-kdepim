...
void ResourceLocalConfig::saveSettings(KRES::Resource *resource)
{
    ...
    if(url.isEmpty())
    {
        ...
        KMessageBox::information(this,
                                 i18n("You did not specify a URL for this resource. Therefore, the resource will be saved in %1. It is still possible to change this location by editing the resource properties.").arg(
                                     file.name()));
