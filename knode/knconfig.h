...
public:
    ...
    bool hasMailCopiesTo()
    {
        return (!m_ailCopiesTo.isEmpty());
    }
    QString mailCopiesTo()
    {
        return m_ailCopiesTo;
    }
    void setMailCopiesTo(const QString &s)
    {
        m_ailCopiesTo = s;
    }
    bool hasOrga()
    {
        return (!o_rga.isEmpty());
    }
    QString orga() const
    {
        return o_rga;
    }
    void setOrga(const QString &s)
    {
        o_rga = s;
    }
    ...
    bool hasSigningKey()
    {
        return (!s_igningKey.isEmpty());
    }
    QCString signingKey()
    {
        return s_igningKey;
    }
    void setSigningKey(const QCString &s)
    {
        s_igningKey = s;
    }
    ...
    bool hasSignature()
    {
        return ((u_seSigFile && !s_igPath.isEmpty()) || !s_igText.isEmpty());
    }
    bool useSigFile() const
    {
        return u_seSigFile;
    }
    bool useSigGenerator()const
    {
        return u_seSigGenerator;
    }
    QString sigPath()const
    {
        return s_igPath;
    }
    QString sigText()const
    {
        return s_igText;
    }
    QString getSignature();
    QString getSigGeneratorStdErr()
    {
        return s_igStdErr;
    }
...
public:
    ...
    {
        return u_seColors ? c_olors[signOkKeyOk] : defaultColor(signOkKeyOk);
    }
    QColor signOkKeyBadColor() const
    {
        return u_seColors ? c_olors[signOkKeyBad] : defaultColor(signOkKeyBad);
    }
    QColor signWarnColor() const
    {
        return u_seColors ? c_olors[signWarn] : defaultColor(signWarn);
    }
    QColor signErrColor() const
    {
        return u_seColors ? c_olors[signErr] : defaultColor(signErr);
    }
    QColor htmlWarningColor() const
    {
        return u_seColors ? c_olors[htmlWarning] : defaultColor(htmlWarning);
    }
...
protected:
    ...
    const QString &colorName(int i) const
    {
        return c_olorNames[i];
    }
    ...
    const QFont &font(int i) const
    {
        return f_onts[i];
    }
    const QString &fontName(int i) const
    {
        return f_ontNames[i];
    }
    int fontCount() const
...
public:
    ...
    {
        return m_arkCrossposts;
    }

    bool smartScrolling()const
    {
        return s_martScrolling;
    }
    ...
    {
        return c_ollCacheSize;
    }
    int artCacheSize()const
    {
        return a_rtCacheSize;
    }
    ...
    QString dateCustomFormat() const
    {
        return mDateCustomFormat;
    }
...
public:
    ...
    {
        return m_arkAllReadGoNext;
    }
    bool markThreadReadGoNext() const
    {
        return m_arkThreadReadGoNext;
    }
    bool markThreadReadCloseThread()const
    {
        return m_arkThreadReadCloseThread;
    }
    bool ignoreThreadGoNext()const
    {
        return i_gnoreThreadGoNext;
    }
    bool ignoreThreadCloseThread()const
    {
        return i_gnoreThreadCloseThread;
    }
    bool leaveGroupMarkAsRead() const
    {
        return mLeaveGroupMarkAsRead;
    }
...
public:
    ...
    {
        return r_emoveTrailingNewlines;
    }
    ...
    {
        return i_nterpretFormatTags;
    }
    void setInterpretFormatTags(bool f)
    {
        d_irty = true;
        i_nterpretFormatTags = f;
    }
    QString quoteCharacters()const
    {
        return q_uoteCharacters;
    }
    ...
    {
        return u_seFixedFont;
    }
    void setUseFixedFont(bool b)
    {
        d_irty = true;
        u_seFixedFont = b;
    }
    ...
    {
        return mAlwaysShowHTML;
    }
    void setAlwaysShowHTML(bool b)
    {
        d_irty = true;
        mAlwaysShowHTML = b;
    }
...
public:
    ...
    QValueList<KNDisplayedHeader *> headers() const
    {
        return mHeaderList;
    }
...
public:
    ...
    int ignoredThreshold()
    {
        return i_gnoredThreshold;
    }
    int watchedThreshold()
    {
        return w_atchedThreshold;
    }
...
public:
    ...
    XHeader &operator=(const XHeader &s)
    {
        n_ame = s.n_ame;
        v_alue = s.v_alue;
        return (*this);
    ...
    QString header()
    {
        return (QString::fromLatin1(("X-" + n_ame + ": ")) + v_alue);
    }
...
public:
    ...
    QStringList composerCharsets()
    {
        return c_omposerCharsets;
    }
    ...
    {
        return a_llow8BitBody;
    }
    bool useOwnCharset() const
    {
        return u_seOwnCharset;
    }
    bool generateMessageID()const
    {
        return g_enerateMID;
    }
    QCString hostname()const
    {
        return h_ostname;
    }
    XHeaders &xHeaders()
    ...
    {
        return d_ontIncludeUA;
    }
    bool useExternalMailer()const
    {
        return u_seExternalMailer;
    }
...
public:
    ...
    {
        return e_xternalEditor;
    }
    bool useExternalEditor()const
    {
        return u_seExtEditor;
    }
...
public:
    ...
    {
        return u_nreadMaxAge;
    }
    bool removeUnavailable() const
    {
        return r_emoveUnavailable;
    }
