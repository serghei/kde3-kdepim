...
public:
    ...
    Control(Content *p, const QCString &s) : Base(p)
    {
        from7BitString(s);
    }
    ...
    bool isCancel()
    {
        return (c_trlMsg.find("cancel", 0, false) != -1);
    }
...
public:
    ...
    Date(Content *p, const QCString &s) : Base(p)
    {
        from7BitString(s);
    }
...
public:
    ...
    Newsgroups(Content *p, const QCString &s) : Base(p)
    {
        from7BitString(s);
    }
...
public:
    ...
    Lines(Content *p, const QCString &s) : Base(p)
    {
        from7BitString(s);
    }
...
public:
    ...
    UserAgent(Content *p, const QCString &s) : Base(p)
    {
        from7BitString(s);
    }
