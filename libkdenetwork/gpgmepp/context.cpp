...
static gpgme_sig_mode_t sigmode2sigmode(Context::SignatureMode mode)
{
    switch(mode)
    {
        default:
        case Context::Normal:
            return GPGME_SIG_MODE_NORMAL;
        case Context::Detached:
            return GPGME_SIG_MODE_DETACH;
        case Context::Clearsigned:
            return GPGME_SIG_MODE_CLEAR;
    }
}
...
std::pair<SigningResult, EncryptionResult> Context::signAndEncrypt(const std::vector<Key> &recipients, const Data &plainText, Data &cipherText,
