...
ProbeDialog::ProbeDialog(QWidget *parent, const char *n) :
    KDialogBase(parent, n, true, i18n("Autodetecting Your Handheld"), KDialogBase::Ok | KDialogBase::Cancel | KDialogBase::User1, KDialogBase::Cancel,
    ...
    mDetected(false), mUserName(), mDevice()
{
    ...
    fInfoText = new QLabel(
        i18n("KPilot is now trying to automatically detect the device of your handheld. Please press the hotsync button if you have not done so already."),
        mainWidget, "fInfoText");
