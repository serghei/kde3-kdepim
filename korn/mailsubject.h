...
public:
     ...
     */
    void setHeader(const QString &header, bool fullMessage)
    {
        _header = header;
     ...
     * @return see above.
     */
    bool isHeaderFullMessage() const
    {
        return _fullMessage;
    }
     ...
     */
    void setMailDrop(KMailDrop *drop)
    {
        _drop = drop;
    }
