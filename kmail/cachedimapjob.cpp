...
void CachedImapJob::execute()
{
    ...
    switch(mType)
    {
        ...
        case tPutMessage:
            ...
            break;
        case tDeleteMessage:
            slotDeleteNextMessages();
            break;
        case tExpungeFolder:
            expungeFolder();
            break;
        case tAddSubfolders:
            slotAddNextSubfolder();
            break;
        case tDeleteFolders:
            slotDeleteNextFolder();
            break;
        case tCheckUidValidity:
            checkUidValidity();
            break;
        case tRenameFolder:
            renameFolder(mString);
            break;
        case tListMessages:
            listMessages();
            break;
...
void CachedImapJob::slotDeleteNextMessages(KIO::Job *job)
{
    ...
    QString uids = mFoldersOrMessages.front();
...
void CachedImapJob::slotGetNextMessage(KIO::Job *job)
{
    ...
    MsgForDownload mfd = mMsgsForDownload.front();
    mMsgsForDownload.pop_front();
