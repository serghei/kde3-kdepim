...
public:
    ...
    KMReaderWin *messageView(void) const
    {
        return mMsgView;
    }
    KMFolderTree *folderTree(void) const
    {
        return mFolderTree;
    }
    ...
    KActionMenu *customReplyAction() const
    {
        return mCustomReplyActionMenu;
    }
    KActionMenu *customReplyAllAction() const
    {
    ...
    KAction *forwardDigestAction() const
    {
    ...
    KActionMenu *customForwardAction() const
    {
    ...
    */
    ...
    KStatusBarLabel *vacationScriptIndicator() const
    {
        return mVacationScriptIndicator;
    }
    void updateVactionScriptStatus()
    {
        updateVactionScriptStatus(mVacationIndicatorActive);
    }
