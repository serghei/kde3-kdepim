...
protected:
    ...
    {
        mComposer->adjustCryptFlags();
    }
    void composeMessage()
    {
        mComposer->composeMessage();
    }
        ...
        Kleo::CryptoMessageFormat format)
{
    ...
    else     // no attachments in the final message
    {
        if(ourFineBodyPart.originalContentTypeStr())
        {
            ...
            kdDebug(5006) << "MessageComposer::addBodyAndAttachments() : set top level Content-Type from originalContentTypeStr()=" <<
