...
public:
    ...
    virtual KIO::TransferJob *createUploadJob(GroupwareDataAdaptor *adaptor,
            const KURL &url);
    virtual KPIM::FolderLister::ContentType itemType()
    {
        return mItemType;
    }
protected:
...
public:
    ...
    */
    ...
    virtual KIO::TransferJob *createDownloadJob(const QMap<KURL, FolderLister::ContentType> &)
    {
        return 0;
    }
    ...
    virtual KIO::TransferJob *createUploadJob(const KURL &, const GroupwareUploadItem::List &/*items*/)
    {
        return 0;
    }
    ...
    virtual KIO::TransferJob *createUploadNewJob(const KURL &, const GroupwareUploadItem::List &/*items*/)
    {
        return 0;
    }
    ...
    virtual bool interpretLoginJobResult(KIO::Job *)
    {
        return true;
    }
    /** Extract the success information from the logoff job, created by
     *  createLogoffJob. */
    virtual bool interpretLogoffJobResult(KIO::Job *)
    {
        return true;
    }
