        ...
        for(int n = 0; n < entry.subentries_count; n++)
        {
            ...
            switch(entry.subentries[n].entry_type)
            {
                ...
                case GN_PHONEBOOK_ENTRY_Postal:
                    ...
                    {
                        case 4:
                            addr->setStreet(addrlist[0].simplifyWhiteSpace());
                            ...
                            break;
                        case 3:
                            addr->setLocality(addrlist[0].simplifyWhiteSpace());
                            ...
                            break;
                        default:
                            addr->setStreet(s.simplifyWhiteSpace());
                    }
...
int KMobileGnokii::storeCalendarEntry(int index, const KCal::Event &event)
{
    ...
    if(event.isAlarmEnabled())
    {
        ...
        if(eventalarm)
        {
            ...
            else if(eventalarm->hasStartOffset())
            {
