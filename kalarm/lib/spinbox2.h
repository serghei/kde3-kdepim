...
public:
    ...
    {
        return mReverseLayout  &&  !mReverseWithLayout;
    }

    /** Returns the spin box's text, including any prefix() and suffix(). */
    QString             text() const
    {
        return mSpinbox->text();
    }
    ...
    {
        mSpinbox->setSpecialValueText(text);
    }
    ...
    {
        return mSpinbox->specialValueText();
    }
...
protected:
    ...
    {
        return mSpinbox->mapValToText(v);
    }
    virtual int         mapTextToValue(bool *ok)
    {
        return mSpinbox->mapTextToVal(ok);
    }
...
private:
    ...
    public:
        ...
        virtual QString mapValueToText(int v)
        {
            return owner->mapValueToText(v);
        }
        virtual int     mapTextToValue(bool *ok)
        {
            return owner->mapTextToValue(ok);
        }
        QString         mapValToText(int v)
        {
            return SpinBox::mapValueToText(v);
        }
        int             mapTextToVal(bool *ok)
        {
            return SpinBox::mapTextToValue(ok);
        }
