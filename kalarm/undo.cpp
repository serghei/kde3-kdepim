...
public:
    ...
    virtual QString   oldEventID() const
    {
        return QString::null;
    }
    virtual QString   newEventID() const
    {
        return QString::null;
    }
    int               id() const
    ...
    Undo::Type        type() const
    {
        return mType;
    }
    void              setType(Undo::Type t)
    {
        mType = t;
    }
    KAEvent::Status   calendar() const
    {
        return mCalendar;
    }
    virtual void      setCalendar(KAEvent::Status s)
    {
        mCalendar = s;
    }
...
protected:
    ...
    void              replaceWith(UndoItem *item)
    {
