...
public:
    ...
    static void      setAlarmsEnabled()
    {
        mInstance->setAlarmsEnabled(true);
    }
    ...
    {
        return mStatus == REGISTERED;
    }
    static void      allowRegisterFailMsg()
    {
...
private slots:
    ...
    void             registerTimerExpired()
    {
        registrationResult((mStatus == REGISTERED), KAlarmd::FAILURE);
    }
