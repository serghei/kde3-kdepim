...
public:
    ...
    TemplateListView      *templateListView() const
    {
        return (TemplateListView *)listView();
    }
    // Overridden base class methods
    TemplateListViewItem  *nextSibling() const
    {
        return (TemplateListViewItem *)QListViewItem::nextSibling();
    }
...
public:
    ...
    TemplateListViewItem  *getEntry(const QString &eventID)
    {
        return (TemplateListViewItem *)EventListViewBase::getEntry(eventID);
    }
    TemplateListViewItem  *selectedItem() const
    {
    ...
    TemplateListViewItem  *firstChild() const
    {
        return (TemplateListViewItem *)EventListViewBase::firstChild();
    }
    virtual void           setSelected(QListViewItem *item, bool selected)
    {
        EventListViewBase::setSelected(item, selected);
    }
    virtual void           setSelected(TemplateListViewItem *item, bool selected)
    {
        EventListViewBase::setSelected(item, selected);
    }
    virtual QValueList<EventListViewBase *> instances()
    {
