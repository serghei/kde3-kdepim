...
public:
    ...
    EventListViewItemBase *firstChild() const
    {
        return (EventListViewItemBase *)KListView::firstChild();
    }
...
public:
    ...
    EventListViewItemBase *nextSibling() const
    {
        return (EventListViewItemBase *)QListViewItem::nextSibling();
    }
