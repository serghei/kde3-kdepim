...
QString EditAlarmDlg::i18n_ConfirmAck()
{
    return i18n("Confirm acknowledgment");
}
QString EditAlarmDlg::i18n_k_ConfirmAck()
{
    return i18n("Confirm ac&knowledgment");
}
QString EditAlarmDlg::i18n_SpecialActions()
{
    return i18n("Special Actions...");
}
QString EditAlarmDlg::i18n_ShowInKOrganizer()
{
    return i18n("Show in KOrganizer");
}
QString EditAlarmDlg::i18n_g_ShowInKOrganizer()
{
    return i18n("Show in KOr&ganizer");
}
QString EditAlarmDlg::i18n_EnterScript()
{
    return i18n("Enter a script");
}
QString EditAlarmDlg::i18n_p_EnterScript()
{
    return i18n("Enter a scri&pt");
}
QString EditAlarmDlg::i18n_ExecInTermWindow()
{
...
QString EditAlarmDlg::i18n_u_ExecInTermWindow()
{
    return i18n("Exec&ute in terminal window");
}
QString EditAlarmDlg::i18n_g_LogToFile()
{
    return i18n("Lo&g to file");
}
QString EditAlarmDlg::i18n_CopyEmailToSelf()
{
    return i18n("Copy email to self");
}
QString EditAlarmDlg::i18n_e_CopyEmailToSelf()
{
    return i18n("Copy &email to self");
}
QString EditAlarmDlg::i18n_s_CopyEmailToSelf()
{
    return i18n("Copy email to &self");
}
QString EditAlarmDlg::i18n_EmailFrom()
{
    return i18n("'From' email address", "From:");
}
QString EditAlarmDlg::i18n_f_EmailFrom()
{
    return i18n("'From' email address", "&From:");
}
QString EditAlarmDlg::i18n_EmailTo()
{
    return i18n("Email addressee", "To:");
}
QString EditAlarmDlg::i18n_EmailSubject()
{
    return i18n("Email subject", "Subject:");
}
QString EditAlarmDlg::i18n_j_EmailSubject()
{
    return i18n("Email subject", "Sub&ject:");
}
...
void EditAlarmDlg::initialise(const KAEvent *event)
{
    ...
    if(event)
    {
        ...
        mRecurrenceEdit->set(*event, (mTemplate
                                      || event->isTemplate()));   // must be called after mTimeWidget is set up, to ensure correct date-only enabling
...
bool EditAlarmDlg::stateChanged() const
{
    ...
    else if(mSavedDateTime != mTimeWidget->getDateTime(0, false, false))
        return true;
        ...
        if(mRecurrenceEdit->subRepeatCount())
        {
                    ...
                    &&  recurEvent.repeatInterval() * recurEvent.repeatCount() >= longestRecurInterval - reminder)
            {
                KMessageBox::sorry(this,
                                   i18n("The duration of a repetition within the recurrence must be less than the recurrence interval minus any reminder period"));
