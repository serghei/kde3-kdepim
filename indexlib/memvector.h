...
public:
    ...
    iterator begin()
    {
        return iterator(address_of(0));
    }
    iterator end()
    {
        return iterator(address_of(size()));
    }

    const_iterator begin() const
    {
        return const_iterator(address_of(0));
    }
    const_iterator end() const
    {
        return const_iterator(address_of(size()));
    }
    ...
    {
        return byte_io::read<uint32_t>(data_->ronly_base(0));
    }
    bool empty() const
    {
        return !size();
